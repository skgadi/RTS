...
\begin{tikzpicture}
	...
	\node[text width=3cm, align= center,	] at (axis cs: 0.0,0.0) {\Huge Arduino \\[0.5cm] AI};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=5, width=5cm, height=5cm]
		\node[text width=3cm, align= center,	] at (axis cs: 0.0,0.0) {\Huge Arduino \\[0.5cm] AO};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=5, width=5cm, height=5cm]
		\node[text width=3cm, align= center,	] at (axis cs: 0.0,0.0) {\Huge Arduino \\[0.5cm] encoder};
	\end{axis}
\end{tikzpicture}
