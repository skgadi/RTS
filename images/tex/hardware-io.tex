...
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=1cm, text width=2cm, text centered,]{\Large Arduino \\ AI};
\end{tikzpicture}

\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=1cm, text width=2cm, text centered,]{\Large Arduino \\ AO};
\end{tikzpicture}

\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=1cm, text width=2cm, text centered,]{\Large Arduino \\ Encoder};
\end{tikzpicture}
