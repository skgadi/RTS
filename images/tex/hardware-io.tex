...
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=1.5, minimum width=0.5cm, minimum height=1.5cm, text width=2cm, text centered,]{\Large Arduino \\ AI};
\end{tikzpicture}

\begin{tikzpicture}
	\node[rectangle, draw=black, line width=1.5, minimum width=0.5cm, minimum height=1.5cm, text width=2cm, text centered,]{\Large Arduino \\ AO};
\end{tikzpicture}

\begin{tikzpicture}
	\node[rectangle, draw=black, line width=1.5, minimum width=0.5cm, minimum height=1.5cm, text width=2cm, text centered,]{\Large Arduino \\ Encoder};
\end{tikzpicture}
