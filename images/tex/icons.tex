...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=6cm, height=3cm]
		\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\Huge \faPlug};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=5cm, height=3cm]
		\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\Huge $f(x)$};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=5cm, height=3cm]
		\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\Huge \faLineChart};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=5cm, height=3cm]
		\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\Huge \faPlus};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=5cm, height=3cm]
	\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\huge $\frac{Y(.)}{U(.)}$};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=1, width=5cm, height=3cm]
		\node[text width=3cm, align= center] at (axis cs: 0.0,0.0) {\Huge \faUsb};
	\end{axis}
\end{tikzpicture}
