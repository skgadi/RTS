...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-0.1, xmax=1, xmin=-1, line width=5]
...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=4, xmin=0, line width=5]
	\addplot [ mark=none] coordinates{(0,0) (1,1) (3,-1) (4,0)};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=2, xmin=0, line width=5]
	\addplot [ mark=none] coordinates{(0,0) (1,1) (1,-1) (2,0)};
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-0.1, xmax=2, xmin=0, line width=5]
