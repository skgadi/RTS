...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-0.1, xmax=1, xmin=-1, line width=5, width=5cm, height=5cm]
		\addplot [ mark=none] coordinates{(-1,0) (0,0) (0,1) (1,1)};
	\end{axis}
\end{tikzpicture}
