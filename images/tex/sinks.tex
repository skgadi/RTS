...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, minor tick num=10, xtick distance=1, ytick distance=1, major grid style={line width=5pt,draw=black}, minor grid style={line width=0.5pt,draw=black}, grid=both, ymax=1, ymin=-1, xmax=1, xmin=-1, line width=5]
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, minor tick num=10, xtick distance=1, major grid style={line width=5pt,draw=black}, minor grid style={line width=0.5pt,draw=black}, grid=both, xmax=1, xmin=-1, ymin=1e-0, ymax=1e2, line width=5, ymode = log, line width=5]
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, minor tick num=10, ytick distance=1, major grid style={line width=5pt,draw=black}, minor grid style={line width=0.5pt,draw=black}, grid=both, ymax=1, ymin=-1, xmin=1e-0, xmax=1e2, line width=5, xmode = log, line width=5]
	\end{axis}
\end{tikzpicture}

\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, minor tick num=10,  major grid style={line width=5pt,draw=black}, minor grid style={line width=0.5pt,draw=black}, grid=both, ymin=1e-0, ymax=1e2, xmin=1e-0, xmax=1e2, line width=5, xmode = log, ymode = log, line width=5]
	\end{axis}
\end{tikzpicture}
