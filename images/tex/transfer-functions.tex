...
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=2cm, text centered, text width=2.8cm,]{Transfer function \\ [0.5cm] \Huge \bf $s$};
\end{tikzpicture}
\begin{tikzpicture}
\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=2cm, text centered, text width=2.8cm,]{Transfer function \\ [0.5cm] \Huge \bf $z$};
\end{tikzpicture}
