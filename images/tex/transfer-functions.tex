...
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=2cm, minimum height=2cm, text centered,]{\Huge $\frac{Y(s)}{U(s)}$};
\end{tikzpicture}
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=2cm, minimum height=2cm, text centered,]{\Huge $\frac{Y(z)}{U(z)}$};
\end{tikzpicture}
