...
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=1cm, text centered,]{\Huge $\frac{Y(s)}{U(s)}$};
\end{tikzpicture}
\begin{tikzpicture}
	\node[rectangle, draw=black, line width=2, minimum width=0.5cm, minimum height=1cm, text centered,]{\Huge $\frac{Y(z)}{U(z)}$};
\end{tikzpicture}
