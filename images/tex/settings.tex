...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=5, width=5cm, height=5cm]
		\node[] at (axis cs: 0.6, 0.6) {\Huge{\faCogs}};
		\node[] at (axis cs: -0.6, 0.6) {\Huge{\faClockO}};
		\node[text width=5cm, align=center,] at (axis cs: 0.0, -0.5) {\Huge Timing};
	\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
	\begin{axis}[domain=-1:1, tick style={draw=none}, ticks=none, ymax=1.1, ymin=-1.1, xmax=1.1, xmin=-1.1, line width=5, width=5cm, height=5cm]
		\node[] at (axis cs: 0.6, 0.6) {\Huge{\faCogs}};
		\node[] at (axis cs: -0.6, 0.6) {\Huge{\faLineChart}};
		\node[text width=5cm, align=center,] at (axis cs: 0.0, -0.5) {\Huge Graphs};
	\end{axis}
\end{tikzpicture}
